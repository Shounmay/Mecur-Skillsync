...
function Footer() {
  const socialLinks = [
    ...
    },
    {
      name: "LinkedIn",
      icon: <FiLinkedin />,
      link: "https://www.linkedin.com/company/mercor-io/",
    },
    {
      name: "Instagram",
      icon: <FiInstagram />,
  ...
  const data = [
    ...
    {
      headerName: "Move From SkillSync",
      links: [
        { name: "SkillSync Business", link: "#" },
        { name: "SkillSync Pro", link: "#" },
        { name: "SkillSync Logo Maker", link: "#" },
        { name: "SkillSync Guides", link: "#" },
        { name: "SkillSync Inspired", link: "#" },
        { name: "SkillSync Select", link: "#" },
        { name: "ClearVoice", link: "#" },
        { name: "SkillSync Workspace", link: "#" },
        { name: "Learn", link: "#" },
